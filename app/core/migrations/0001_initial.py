# Generated by Django 4.2.10 on 2024-02-27 02:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('frequency', models.CharField(choices=[('yearly', 'Yearly'), ('hourly', 'Hourly'), ('every_1m', 'Every min'), ('weekly', 'Weekly'), ('every_30m', 'Every 30 min'), ('every_10m', 'Every 10 min')], default='hourly', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
